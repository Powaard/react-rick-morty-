...
const EpisodeDetailPage = () => {
  ...
  const handleToggleFavorite = (characterId) => {
    if (isFavorite(characterId)) {
      ...
      // Favori karakter sayısı 10'u geçtiğinde uyarı mesajı gösterir
  ...
  // Karakter adına veya özelliklere göre filtreleme yapan fonksiyon
  ...
  return (
   ...
   <div
              ...
              >
                ...
                <button
                     onClick={(e) => {
                      e.preventDefault(); // Sayfaya geçişi engeller
